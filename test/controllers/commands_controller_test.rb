...
class CommandsControllerTest < ActionController::TestCase
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post :create, command: { command: @command.command, description: @command.description, server_id: @command.server_id }
    end
  ...
  test "should update command" do
    patch :update, id: @command, command: { command: @command.command, description: @command.description, server_id: @command.server_id }
    assert_redirected_to command_path(assigns(:command))
  end
